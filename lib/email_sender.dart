...
class _EmailSenderState extends State<EmailSender> {
  ...
  final _subjectController =
      TextEditingController(text: 'Menu-Scanner Bug Report');

  final _bodyController = TextEditingController(
    text:
        'Please share detailed reviews of your experience below. Also, take snapshots of the filtered image and attach them with this bug report.',
  );
  ...
  Future<void> send() async {
    final Email email = Email(
      ...
      recipients: [globals.developer_email],
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content:
            Text("Thank you for sharing your response. You are a rockstar!"),
      ),
    );
  }
            ...
            Padding(
              ...
              child: TextField(
                ...
                decoration: const InputDecoration(
                  border: OutlineInputBorder(),
                  labelText: 'Please add subject of the email',
                ),
              ),
            ),
            Expanded(
